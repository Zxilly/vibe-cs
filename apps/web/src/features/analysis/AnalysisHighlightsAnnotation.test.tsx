...
import { HighlightsView } from './AnalysisPage';
...
describe('analysis Highlights annotation workflow', () => {
  it('exposes the exact persisted review action on each canonical highlight card', () => {
