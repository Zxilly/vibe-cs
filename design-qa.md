...
- Browser-rendered implementation: `target/premiere-light/07-final.png`.
- Full same-input comparison: `target/premiere-light/07-full-comparison.png`.
...
- State: real Project revision 11, latest Agent Change Group projected inline, playhead at 01:51.350, 11/11 Story clips materialized.
