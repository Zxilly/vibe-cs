...
import { CAPTURE_POST_ROLL_SECONDS, CAPTURE_PRE_ROLL_SECONDS, collectedClipRange, collectedClipsPatch, collectedClipsStart, type ProjectCollectedClip } from './collectedClip';
