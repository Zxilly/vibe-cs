...
export const queueTestItems: QueueItem[] = [
  {
    ...
    preRollSeconds: 3, postRollSeconds: 2.5, playbackSpeed: 1, perspective: 'pov', showKeyboard: true, showKillFx: true, enabled: true, origin: 'demo',
  },
  {
    ...
    preRollSeconds: 4, postRollSeconds: 3, playbackSpeed: 1, perspective: 'pov', showKeyboard: false, showKillFx: true, enabled: true, origin: 'demo',
  },
  {
    ...
    preRollSeconds: 2.5, postRollSeconds: 2, playbackSpeed: 0.75, perspective: 'pov', showKeyboard: false, showKillFx: false, enabled: true, origin: 'demo',
  },
];
