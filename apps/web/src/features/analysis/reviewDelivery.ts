...
<header><small>VIBE CS · REVIEW DELIVERY</small><h1>${escapeHtml(workspace.map_name)}</h1><div class="meta"><span>Demo ${escapeHtml(workspace.demo_id)}</span><span>Generated ${escapeHtml(generatedIso)}</span></div></header>
