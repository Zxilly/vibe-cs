...
export const queueTestItems: QueueItem[] = [
  {
    ...
    preRollSeconds: 3, postRollSeconds: 2.5, perspective: 'pov', cameraStyle: 'pov', enabled: true, origin: 'demo',
  },
  {
    ...
    preRollSeconds: 4, postRollSeconds: 3, perspective: 'pov', cameraStyle: 'pov', enabled: true, origin: 'demo',
  },
  {
    ...
    preRollSeconds: 2.5, postRollSeconds: 2, perspective: 'pov', cameraStyle: 'pov', enabled: true, origin: 'demo',
  },
];
